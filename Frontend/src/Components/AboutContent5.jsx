...
const AboutContent5 = () => {
  return (
    <div className=" w-screen h-auto min-h-[300px] bg-black flex flex-col md:flex-row items-center justify-between p-6 relative">
        ...
        <div className="w-full md:w-[70%] h-auto min-h-[120px] flex flex-col items-center justify-center text-white text-lg text-center md:text-left mx-5 gap-1">
            <motion.p 
                initial={{ opacity: 0, translateX: "-50%" }}
                whileInView={{ opacity: 1, translateX: "0" }}
                transition={{ delay: 0.7, duration: 1, ease: "easeOut" }}
                viewport={{ once: true }}
                className="text-base md:text-3xl p-1">
