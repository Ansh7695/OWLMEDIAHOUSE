...
const Banner2 = () => {
  return (
    <div className="w-screen h-auto min-h-[300px] bg-black flex flex-col md:flex-row items-center justify-between p-6 relative">
        ...
        <div className="w-full md:w-1/3 h-auto min-h-[250px] flex flex-col items-center justify-center text-white text-lg font-bold mx-4 relative overflow-hidden">
            {/* Large "01" - Increased Size */}
            <motion.h1 
            ...
            {/* "AUDIT" - Centered in the middle of "01" */}
            <motion.h2 
                initial={{ opacity: 0, translateX: "-50%" }}
                whileInView={{ opacity: 1, translateX: "0" }}
                transition={{ delay: 0.7, duration: 1, ease: "easeOut" }}
                viewport={{ once: true }}
                className="text-4xl md:text-6xl lg:text-5xl font-bold bg-black px-18 text-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                AUDIT
            </motion.h2>
        </div>
